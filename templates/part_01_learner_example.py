...
Il = imread("../assignment_3/images/cones/cones_image_02.png", as_gray = True)
Ir = imread("../assignment_3/images/cones/cones_image_06.png", as_gray = True)
...
It = imread("../assignment_3/images/cones/cones_disp_02.png",  as_gray = True)/4.0

# Load the appropriate bounding box.
bbox = np.load("../assignment_3/data/cones_02_bounds.npy")
